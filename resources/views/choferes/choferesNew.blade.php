...
@section('content')
    <div class="">
        <div class="text-center">
            <h2 class="box-title"><b>Nuevo Chofer</b></h2>
        </div>
        <form id="formChoferesNuevo" method="post"  action="{{ route('chofer.store') }}" class="form_entrada">
                ...
                <div class="box-body col-xs-12">        
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <input type="date" class="form-control" id="vigencia" name="vigencia" placeholder="Vigencia Licencia" >
                    </div>
